...
################################################ File Picker ################################################################### 
    ...
    def animate_popup_1():
        ...
        if(cl==[]):
            ...
            popup_continer_1.content=ft.Text("This file doesnt contian any virus.")
    ...
    def animate_popup_2(pridict,filelocation):
        ...
        if(pridict[0]==0):
            ...
            file_main_image.height=0
            popup_continer_2.content=ft.Column(controls=[
                ft.Container(ft.Text("Virus has been Detected In This File",text_align="center",color="white",width=600),width=600,border_radius=3,height=20),cl_2,delete_button_2,
            ])
            page.update()
            time.sleep(0.5)
            popup_continer_2.expand=True
    ...
    file_main_image=ft.Container(ft.Row(controls=[file_main,ft.Text("File Analyzer",text_align="center",size=35,weight=ft.FontWeight.W_500)]),alignment=ft.alignment.center_left,width=500,animate=ft.animation.Animation(600,"bounceOut"),height=60,bgcolor="#405762")
