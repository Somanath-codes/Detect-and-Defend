...
# background_image_path = os.path.join(current_dir, 'images_proj', 'cybgpic.jpg')
...
def main(page:ft.Page):    
    ...
    def delete_virus(e):
        ...
        if virus!=[]:
            ...
            popup_continer_1.content=ft.Container(
                ft.Text("""Congratulations! Your system is now secure.\nMandelBox has successfully detected and removed a potential threat from your computer.\nYour safety and privacy are our top priorities.\nIf you have any further concerns or questions, feel free to contact our support team.\nThank you for using MandelBox to keep your system protected!
            ...
            popup_continer_1.content=ft.Container(
                ft.Text("""No Files Selected\nVirus is present In Your System
    ...
    delete_button=ft.Container(ft.Column(controls=[
        ...
        ft.Container(ft.Row(controls=[ft.Container(width=5),ft.Text("Do you want to Exterminate the \"Virus\" files",width=600,color="white",weight=ft.FontWeight.W_500)]),width=600),
    ...
    delete_button_2=ft.Container(ft.Column(controls=[
        ft.Container(ft.Row(controls=[ft.Container(width=5),ft.Text("Do you want to Exterminate the \"Virus\" file",width=600,color="white",weight=ft.FontWeight.W_500)]),width=600),
...
################################################ File Picker ################################################################### 
    ...
    def animate_popup_1():
        ...
        if(cl==[]):
            ...
            popup_continer_1.content=ft.Text("This file doesnt contain any virus.")
            ...
            popup_continer_1.content=ft.Column(controls=[
                ft.Container(ft.Text("Virus Has been Detected In Your System",text_align="center",color="white",width=600),width=600,border_radius=3,height=20),cl,delete_button
            ])
    ...
    def animate_popup_2(pridict,filelocation):
        ...
        if(pridict[0]==0):
            ...
            file_main_image.height=0
            popup_continer_2.content=ft.Text("CONGRAGULATIONS, We didn't find any virus in this File")
            page.update()
            time.sleep(4)
            popup_continer_2.height=0
            file_main_image.height=60
            ...
            cl_2.controls.append(ft.Container(ft.Row(controls=[ft.Container(ft.Text("Classification Summary",color="#ffffff"),expand=True)])))

            llm_ans=summaro(str(md0))
            print(llm_ans)
            
            cl_2.controls.append(ft.Container(ft.Row(controls=[ft.Container(ft.Text(llm_ans[:20],color="#ffffff"),expand=True)])))
            ...
            cl_2.controls.append(ft.Container(ft.Row(controls=[ft.Container(ft.Text("Classification Summary"),expand=True)])))
            ...
            cl_2.controls.append(ft.Container(ft.Row(controls=[ft.Container(ft.Text(llm_ans,color="#ffffff"),expand=True)])))
            ...
            file_main_image.height=0
            popup_continer_2.content=ft.Column(controls=[
                ft.Container(ft.Text("Virus has been Detected In This File",text_align="center",color="white",width=600),
    ...
    def file_detect(e):
        ...
        pridict,md0=combinatrix2a.maha_predicto(file_loactions[0])
    ...
    upload_button=ft.Container(content=ft.Row(controls=[ft.Container(ft.Image(file_upload,width=40,height=40,fit=ft.ImageFit.CONTAIN),
                                                                     width=40,height=40,margin=ft.margin.only(left=17)),
                                                        ft.Text("Upload",text_align=ft.alignment.center,color="black")]),on_click=file_detect,height=40,width=180,
                               disabled=True,bgcolor="#dddddd",alignment=ft.alignment.center,border_radius=15,margin=ft.margin.only(left=170,right=170))
    ...
    file_content=ft.Container(ft.Column(controls=[file_image,ft.Container(ft.Column(controls=[file_select_button,upload_button],spacing=10,width=500,height=100,
                                                                                    alignment=ft.MainAxisAlignment.CENTER),width=500,height=100,
                                                                          margin=ft.margin.only(bottom=100),alignment=ft.alignment.center)],alignment=ft.MainAxisAlignment.SPACE_EVENLY,width=500,height=1200,scroll=ft.ScrollMode.AUTO),
                              width=500,height=600,expand=True,alignment=ft.alignment.center,bgcolor="#4A6572")
    ...
    file_main_image=ft.Container(ft.Row(controls=[file_main,ft.Text("File Analyzer",text_align="center",size=35,weight=ft.FontWeight.W_500)]),
                                 alignment=ft.alignment.center_left,width=500,animate=ft.animation.Animation(600,"bounceOut"),height=60,bgcolor="#405762")
    ...
    pdf_content=ft.Container(ft.Column(controls=[file_image,ft.Container(ft.Column(controls=[file_select_button,upload_button],spacing=10,width=500,height=100,
                                                                                    alignment=ft.MainAxisAlignment.CENTER),width=500,height=100,
                                                                          margin=ft.margin.only(bottom=100),alignment=ft.alignment.center)],
                                       alignment=ft.MainAxisAlignment.SPACE_EVENLY,width=500,height=1200,scroll=ft.ScrollMode.AUTO),
                              width=500,height=600,expand=True,alignment=ft.alignment.center,bgcolor="#4A6572")

    pdf_select_button=ft.Container(content=ft.Row(controls=[ft.Container(ft.Image(src=file_f_png,width=30,height=30,fit=ft.ImageFit.CONTAIN),
                                                                         width=30,height=30,margin=ft.margin.only(left=15)),
                                                            ft.Text("Select a File",text_align=ft.alignment.center)]),
                                   on_click=lambda _: file_picker.pick_files(allow_multiple=True),
                                    height=40,width=180,bgcolor="#3498db",alignment=ft.alignment.center,
                                   border_radius=15,margin=ft.margin.only(left=170,right=170))

    pdf_picker_content=ft.Container(
        ft.Column(controls=[popup_continer_2,
                            file_main_image,
                            pdf_content
            ]),
...
############    network_pridict=
    ...
    time_1=ft.TextField(label="Enter Number of Seconds",hint_text="Enter Seconds",width=350,height=70,border=False,on_change=network_button_enable,on_submit=network_check)
...
############################################## Title bar ########################################################################
    ...
    toolbar_height=60,
    bgcolor="light_green",
    title=ft.Text("MandelBox",color="white"),  
    )
############################################## Change Navigation ###############################################################    
