...
def predicto_2(s):
    ...
    try:
        ...
        return "code: Success",maino,mahadict
    except ValueError:
        return "parse incomplete : absence of vital sections of the pe file, indicating obsfurcation and malware behaviour",[np.array([1]),[0.5,0.5]],mahadict
