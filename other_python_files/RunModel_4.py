...
def predicto_4(s):
    ...
    try:
        ...
        maino.append(probs)
        return "code: Success",maino,mahadicto
    except ValueError:
        return "parse incomplete : absence of vital sections of the pe file, indicating obsfurcation and malware behaviour",[np.array([1]),[0.5,0.5]],mahadicto
