...
def maha_predicto(s):
    ...
    if(remo.endswith(".dll")):
        ...
        try:
            ...
            p1,dicto_1=r1.predicto_1(s)
            err_2,p2,dicto_2=r2.predicto_2(s)
            err_3,p3=r3.predicto_3(s)
            err_4,p4,dicto_4=r4.predicto_4(s)
            p5=r5.predicto_5(s)
        ...
        dicto_1.update(dicto_2)
        dicto_1.update(dicto_4)

        return tot,dicto_1
#put the path of the PE file above


#z,ero=maha_predicto(r"C:\pixel art\aseprite\build\bin\aseprite.exe")
#print(ero)
